package com.example.salamport.database
...
import com.example.salamport.models.UserModel
import com.example.salamport.utilits.APP_ACTIVITY
import com.example.salamport.utilits.AppValueEventListener
import com.example.salamport.utilits.TYPE_MESSAGE_IMAGE
import com.example.salamport.utilits.showToast
...
inline fun getUrlFromStorage(path: StorageReference, crossinline function: (url: String) -> Unit) {
    // Получает юрл картинку из облачного хранилища
    path.downloadUrl
...
inline fun initUser(crossinline function: () -> Unit) {
    // Инииализация модели пользователя
    REF_DATABASE_ROOT.child(NODE_USERS).child(
        CURRENT_UID
    )
